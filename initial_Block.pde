...
void initialBlock() {
  ...
  if (blockInitial == 2) {   // scenario 1 block
    b0 = new Block(0, "stair", new PVector(464, 290), new int[] {
      100, 7, 100, 100
    }
    , new int[] {
      100, 100, 8, 100
    ...
    b1 = new Block(1, "yellow", new PVector(422, 449), new int[] {
      7, 6, 100, 100
    }
    , new int[] {
      0, 4, 100, 100
    ...
    //Stairs
    b2 = new Block(2, "start", new PVector(316, 604), new int[] {
      100, 100, 100, 3
    }
    , new int[] {
      100, 100, 100, 100
    ...
    b3 = new Block(3, "normal", new PVector(352, 580), new int[] {
      4, 100, 2, 100
    }
    , new int[] {
    }
    ...
    b4 = new Block(4, "normal", new PVector(386, 547), new int[] {
      6, 3, 100, 100
    }
    , new int[] {
      1, 100, 2, 100
    ...
    b5 = new Block(5, "normal", new PVector(350, 517), new int[] {
      100, 4, 100, 6
    }
    , new int[] {
    }
    ...
    b6 = new Block(6, "normal", new PVector(404, 497), new int[] {
      1, 4, 100, 100
    }
    , new int[] {
    }
    ...
    b7 = new Block(7, "start", new PVector(443, 369), new int[] {
      0, 1, 100, 100
    }
    , new int[] {
    }
    ...
    b8 = new Block(8, "final", new PVector(357, 266), new int[] {
    }
    , new int[] {
      100, 100, 100, 0
    }
    ...
    b9 = new Block(9, "yellow", new PVector(1028, 397), new int[] {
      14, 13, 100, 100
    }
    , new int[] {
      100, 12, 100, 100
    ...
    b10 = new Block(10, "start", new PVector(1060, 605), new int[] {
      100, 100, 11, 100
    }
    , new int[] {
      100, 100, 12, 100
    ...
    b11 = new Block(11, "normal", new PVector(1035, 545), new int[] {
      100, 100, 12, 10
    }
    , new int[] {
    }
    ...
    b12 = new Block(12, "normal", new PVector(1000, 485), new int[] {
      13, 100, 100, 11
    }
    , new int[] {
      9, 100, 100, 10
    ...
    b13 = new Block(13, "normal", new PVector(1000, 485), new int[] {
      9, 12, 100, 100
    }
    , new int[] {
    }
    ...
    b14 = new Block(14, "normal", new PVector(1069, 350), new int[] {
      16, 9, 15, 100
    }
    , new int[] {
    }
    ...
    b15 = new Block(15, "normal", new PVector(1033, 326), new int[] {
      100, 14, 100, 16
    }
    , new int[] {
      100, 100, 100, 17
    ...
    b16 = new Block(16, "normal", new PVector(1070, 305), new int[] {
      17, 14, 15, 100
    }
    , new int[] {
    }
    ...
    b17 = new Block(17, "final", new PVector(1106, 265), new int[] {
      100, 16, 100, 100
    }
    , new int[] {
      100, 100, 15, 100
